const resources = {
  en: {
    translation: {
      ...
      welcomeMessage: "Welcome. Paste text or upload a file, choose a tool, and I’ll help you study better.",
  ...
  ar: {
    translation: {
      ...
      welcomeMessage: "مرحباً. الصق النص أو ارفع ملفاً، اختر الأداة، وسأساعدك على الدراسة بشكل أفضل.",
